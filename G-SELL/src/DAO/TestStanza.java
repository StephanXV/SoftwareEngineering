	...
	public static Stanza getStanza (int id_stanza) throws SQLException {
		...
		//attributi sensore
		  ...
		  try {
		   ...
		   String query2 = "SELECT Min_ValueTemperatura, Max_ValueTemperatura, Min_ValuePressione, Max_ValuePressione, Min_ValueUmidit�, Max_ValueUmidit�, Min_ValueLuminosit�, Max_ValueLuminosit� FROM Valori_Associati WHERE ID = (" + query1 + ") ;";
		   ...
		   while (rs.next() == true) {
		    ...
		    min_lum=rs.getDouble("Min_ValueLuminosit�");
		    max_lum=rs.getDouble("Max_ValueLuminosit�");
		    min_pres=rs.getDouble("Min_ValuePressione");
		    max_pres=rs.getDouble("Max_ValuePressione");
		    min_hum=rs.getDouble("Min_ValueUmidit�");
		    max_hum=rs.getDouble("Max_ValueUmidit�"); 
