...
public class Stanza {
	...
	private int floor;
	private List<Sensore> l1 = new ArrayList<Sensore>();
	...
	public Stanza(String room_name, int floor, List<Sensore> l1, Priority room_priority, Valori valori) {
	...
	public List<Sensore> getL1() {
		return l1;
	}
	public void setL1(List<Sensore> l1) {
		this.l1 = l1;
	}
