...
public class StanzaTabella {
    ...
    public StanzaTabella(String nome, Double avg_temp, Double avg_um, Double avg_pres, Double avg_lum) {
        this.nome = nome;
    ...
    public StanzaTabella(Double avg_temp, Double avg_um, Double avg_pres, Double avg_lum) {
        this.avg_temp = avg_temp;
        this.avg_um = avg_um;
        this.avg_pres = avg_pres;
        this.avg_lum = avg_lum;
